...
class FlashDealFragment  //  priva root: 
    : Fragment() {
    ...
    private fun setData() {
        ...
        val myRef = database.getReference("product").child("flashSale")
...
/*
    fun callApi() {
        ...
        callRecentlyViewedProducts.enqueue(object : Callback<TradzHubProductModel> {
